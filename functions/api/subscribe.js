...
const ALLOWED_SOURCES = new Set([
  ...
  'source-wiki-index',
  'source-wiki-fawn-response',
  'source-wiki-cyclic-sighing',
  'source-wiki-diving-reflex',
  'source-wiki-diaphragmatic',
  'source-wiki-humming',
  'source-wiki-non-negotiables',
  'source-wiki-state-matched',
  'source-wiki-transition',
  'source-wiki-meltdown-ews',
  'source-wiki-five-task-reframe',
  'source-wiki-validate-redirect',
  'source-wiki-coparent',
  'source-wiki-school-advocacy',
  'source-wiki-medication',
  'source-wiki-rsd-recognition',
  'source-wiki-rsd-de-escalation',
  'source-wiki-partner-rsd',
  'source-wiki-scarf',
  'source-wiki-polyvagal',
  'source-wiki-harvard',
  'source-wiki-gottman',
  'source-wiki-termination',
  'source-wiki-salary',
  'source-wiki-pre-bet',
  'source-wiki-tilt',
  'source-wiki-mhh',
  'source-wiki-magic-keys',
  'source-wiki-ef-scaffolding',
]);
